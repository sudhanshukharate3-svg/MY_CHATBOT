...
export function ChatView() {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-black dark:bg-black">
      {/* Sidebar - Sticky on left */}
      <aside className="hidden h-screen w-80 flex-shrink-0 overflow-y-auto border-r border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 lg:flex lg:flex-col">
        <div className="flex items-center justify-between gap-2">
          ...
          <button
            type="button"
            className="flex-shrink-0 rounded-xl border border-zinc-200 bg-white px-3 py-2 text-xs font-medium text-zinc-700 hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-200 dark:hover:bg-zinc-800"
            onClick={logout}
          >
            Logout
          </button>
        ...
        <div className="mt-4 flex gap-2">
          ...
          <button
            type="button"
            className={clsx(
              "flex-shrink-0 rounded-xl border px-3 py-2 text-sm font-semibold",
              voiceEnabled
      ...
      <section className="flex flex-1 flex-col overflow-hidden">
        ...
        <div ref={listRef} className="flex-1 overflow-y-auto border-b border-zinc-200 bg-zinc-950 p-4 dark:border-zinc-800 dark:bg-black">
          {error && (
        ...
        <div className="flex-shrink-0 border-t border-zinc-200 bg-zinc-950 p-4 dark:border-zinc-800 dark:bg-black">
          <div className="flex items-center gap-2">
            <button
              type="button"
              className={clsx(
                "inline-flex flex-shrink-0 items-center gap-2 rounded-xl border px-3 py-2 text-sm font-semibold",
                listening
            ...
            <input
              className="flex-1 rounded-xl border border-zinc-200 bg-white px-4 py-2 text-sm outline-none ring-indigo-500/30 focus:ring-4 dark:border-zinc-800 dark:bg-zinc-950"
              value={composer}
            ...
            <button
              type="button"
              className="flex-shrink-0 rounded-xl bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-soft hover:bg-indigo-500 disabled:opacity-60"
